...
int main() {
	...
	printf ("Hello World."); // This is printf, a function that allows us to output a formatted string of characters, 
...
// I recommend rewriting the code yourself by memory to get accostumed 
// to each function.
